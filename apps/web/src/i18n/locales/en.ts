...
export const en: Dict = {
  ...
  'fileViewer.previewLoadFailedTitle': 'Preview unavailable',
  'fileViewer.previewLoadFailedDetail': 'The file could not be loaded from the project. Reload to try again.',
  'fileViewer.emptyHtmlPreviewTitle': 'This HTML file is empty',
  'fileViewer.emptyHtmlPreviewDetail': 'Open Code to inspect the file or add HTML content, then reload the preview.',
